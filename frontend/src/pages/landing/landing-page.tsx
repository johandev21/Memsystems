...
const NAV_ITEM_TRANSITION = { duration: 0.18, ease: EASE_OUT };
  ...
  return (
    <span className={`inline-block ${!isLast ? "mr-[0.24em]" : ""}`}>
      {shouldReduceMotion ? (
        ...
        <motion.span style={{ opacity, y, display: "inline-block" }} className="text-foreground">
          {word}
        </motion.span>
      )}
    </span>
    ...
    <div className="min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <header className="relative z-20 px-4 pt-4 sm:px-6 sm:pt-6">
        ...
        >
          ...
          <Button render={<Link to="/login" />} className="hidden cursor-pointer md:inline-flex">
            Start free
          </Button>
          ...
          {menuOpen && (
            ...
            >
              <div className="flex flex-col gap-6 text-4xl font-semibold tracking-[-0.05em]">
                {MOBILE_NAV_ITEMS.map(([label, href], index) => (
                  <motion.a
                    key={label}
                    href={href}
                    onClick={handleMenuClose}
                ...
                >
                  <Button
                    render={<Link to="/login" onClick={handleMenuClose} />}
                    size="lg"
      ...
      <main id="main-content">
        ...
        >
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              Memsystems brings research, notes, and AI into one quiet workspace so you can go from
              scattered reading to a point of view.
            </motion.p>
