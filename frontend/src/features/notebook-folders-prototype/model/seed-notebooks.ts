import { SEED_BANNER_VARIANTS } from "./seed-banner-assets";
...
export const SEEDED_NOTEBOOKS: SeedNotebook[] = [
  {
    ...
    icon: "CircleDot",
    coverUrl: SEED_BANNER_VARIANTS.plato.w960,
    coverVariants: SEED_BANNER_VARIANTS.plato,
    folderId: "folder-two",
  },
  {
    id: "seed-aristotle",
    ...
    icon: "Cloud",
    coverUrl: SEED_BANNER_VARIANTS.aristotle.w960,
    coverVariants: SEED_BANNER_VARIANTS.aristotle,
    folderId: "folder-one",
  },
  {
    id: "seed-socrates",
    ...
    coverUrl: SEED_BANNER_VARIANTS.socrates.w960,
    coverVariants: SEED_BANNER_VARIANTS.socrates,
    folderId: "folder-two",
  },
  {
    id: "seed-kant",
    ...
    icon: "Scale",
    coverUrl: SEED_BANNER_VARIANTS.kant.w960,
    coverVariants: SEED_BANNER_VARIANTS.kant,
  ...
  },
  {
    ...
    icon: "Brain",
    coverUrl: SEED_BANNER_VARIANTS.descartes.w960,
    coverVariants: SEED_BANNER_VARIANTS.descartes,
    folderId: "folder-many",
  },
  {
    id: "seed-confucio",
    ...
    icon: "BookOpen",
    coverUrl: SEED_BANNER_VARIANTS.confucio.w960,
    coverVariants: SEED_BANNER_VARIANTS.confucio,
    folderId: "folder-many",
  },
  {
    id: "seed-nietzsche",
    ...
    icon: "Hammer",
    coverUrl: SEED_BANNER_VARIANTS.nietzsche.w960,
    coverVariants: SEED_BANNER_VARIANTS.nietzsche,
    folderId: "folder-many",
  },
  {
    id: "seed-locke",
    ...
    icon: "KeyRound",
    coverUrl: SEED_BANNER_VARIANTS.locke.w960,
    coverVariants: SEED_BANNER_VARIANTS.locke,
    folderId: "folder-many",
  },
  {
    id: "seed-hume",
    ...
    icon: "Eye",
    coverUrl: SEED_BANNER_VARIANTS.hume.w960,
    coverVariants: SEED_BANNER_VARIANTS.hume,
    folderId: null,
  },
  {
    id: "seed-marx",
    ...
    icon: "Factory",
    coverUrl: SEED_BANNER_VARIANTS.marx.w960,
    coverVariants: SEED_BANNER_VARIANTS.marx,
    folderId: null,
  },
];
