...
export function childFolders(folders: LibraryFolder[], parentId: string | null) {
...
export function canMoveFolder(folders: LibraryFolder[], folderId: string, parentId: string | null) {
...
export function descendantNotebooks(folders: LibraryFolder[], notebooks: LibraryNotebook[], folderId: string) {
...
export function folderPath(folders: LibraryFolder[], folderId: string) {
