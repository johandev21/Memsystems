...
ALTER TABLE "app_settings" ADD COLUMN "indexing_representation" varchar(200);--> statement-breakpoint
ALTER TABLE "source_chunks" ADD COLUMN "heading_path" jsonb DEFAULT '[]'::jsonb NOT NULL;--> statement-breakpoint
ALTER TABLE "source_chunks" ADD COLUMN "source_kind" "source_kind";--> statement-breakpoint
...
ALTER TABLE "source_chunks" ADD COLUMN "context_header" text DEFAULT '' NOT NULL;
