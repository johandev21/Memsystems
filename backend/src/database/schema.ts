...
/**
 * Postgres `tsvector`, the indexed lexical representation of a chunk. The
 * column is generated by the database from the chunk's searchable text, so
...
export const sourceChunks = pgTable(
  'source_chunks',
  {
    ...
    /**
     * The indexed lexical representation, generated with the `simple`
     * configuration: no stemming and no stop words, so exact identifiers and
     * mixed-language terms survive intact. The value is never written by the
     * application.
     */
    searchVector: tsvector('search_vector').generatedAlwaysAs(
      sql`to_tsvector('simple', "source_chunks"."searchable_text")`,
    ),
