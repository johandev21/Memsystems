...
## Corpus Check
- 548 files · ~286,849 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4567 nodes · 7962 edges · 375 communities (270 shown, 105 thin omitted)
...
- `StudioResourcesProps` --references--> `StudyMaterialKind`  [EXTRACTED]
  frontend/src/features/notebooks/components/shared/studio-resources.tsx → frontend/src/entities/study-material/types.ts
...
## Communities (375 total, 105 thin omitted)
...
### Community 2 - "cn"
Cohesion: 0.04
Nodes (66): detectDocumentType(), ReaderControls, SourceContentViewer(), SourceContentViewerProps, SourceDocument(), useSourceReaderControls(), FlashcardModelPopover(), renderModelRow() (+58 more)

### Community 3 - "prompt-input.tsx"
Cohesion: 0.02
Nodes (80): usePromptInputDropTarget(), capturePromptInputScreenshot(), AttachmentsContext, LocalAttachmentsContext, LocalReferencedSourcesContext, PromptInput(), PromptInputActionAddAttachments(), PromptInputActionAddAttachmentsProps (+72 more)

### Community 4 - "button.tsx"
Cohesion: 0.06
Nodes (65): ModelOption, ModelsResponse, StudyMaterialKind, ComposerProps, DialogModelSelectorProps, ModelRow(), ModelRowProps, ModelSelectorProps (+57 more)
...
Cohesion: 0.15
Nodes (13): buttonVariants, ResizableHandle(), ResizablePanel(), ResizablePanelGroup(), ScrollArea(), ScrollBar(), DEFAULT_WORKSPACE_LAYOUT, DesktopLayout() (+5 more)
...
### Community 11 - "react"
Cohesion: 0.06
Nodes (47): DEFAULT_FOCAL_POINT, NotebookBanner(), NotebookBannerProps, NotebookCardPreview(), NotebookCardPreviewProps, NotebookDescription(), NotebookDescriptionProps, clamp() (+39 more)
...
Cohesion: 0.11
Nodes (13): Notebook, NotebooksResponse, StudyMaterialsTreeSkeleton(), formatUpdatedAt(), RecentNotebookGrid(), SectionHeader(), SectionHeaderProps, EmptyState() (+5 more)

### Community 17 - "QuizView.tsx"
Cohesion: 0.09
Nodes (28): ACCEPTED_IMAGE_TYPES, ImageUploadDialog(), ImageUploadDialogProps, resizeBannerImage(), useModelPersistence(), MindMapOptions, RoadmapOptions, GenerateBriefDialog() (+20 more)
...
Cohesion: 0.13
Nodes (20): ClearHistoryDialogProps, EDIT_NOTEBOOK_EVENT, NotebookSettingsDialogProps, keyLooksValid(), Provider, providerConfig, ProviderKeyRow(), AlertDialog() (+12 more)
...
### Community 30 - "controller.tsx"
Cohesion: 0.11
Nodes (37): LocalTreeAdapter, useLocalTreeAdapter(), CommandResult, TreeCommand, addToMap(), buildStudyMaterialTree(), byCreatedAtThenId(), canMoveItem() (+29 more)

### Community 31 - "sources.ts"
Cohesion: 0.22
Nodes (14): Source, SourceKind, SourceWithContent, getKindIcon(), PendingUploadRow(), PendingUploadRowProps, getIcon(), SourceRow() (+6 more)
...
Cohesion: 0.07
Nodes (39): TreeNode, DRAG_ID_PREFIX, FOLDER_DROP_ID_PREFIX, useTreeControllerContext(), TreeBranchList(), TreeContent(), TreeRootMenu(), Branch() (+31 more)
...
Cohesion: 0.09
Nodes (24): ConnectionPage(), SettingsLayout(), SettingsPage(), Route, Route, Route, Route, FileRoutesByFullPath (+16 more)
...
Cohesion: 0.09
Nodes (27): Conversation(), ConversationContent(), ConversationContentProps, ConversationDownload(), ConversationDownloadProps, ConversationEmptyState(), ConversationEmptyStateProps, ConversationItem (+19 more)

### Community 42 - "assistant-message.tsx"
Cohesion: 0.08
Nodes (29): Message(), MessageContent(), MessageResponseProps, AssistantMessage(), AssistantMessageProps, getReasoningText(), isTextPart(), MessageComponents (+21 more)
...
Cohesion: 0.05
Nodes (48): ModelSelector(), ModelSelectorContent(), ModelSelectorContentProps, ModelSelectorDialogProps, ModelSelectorEmpty(), ModelSelectorEmptyProps, ModelSelectorGroup(), ModelSelectorGroupProps (+40 more)
...
### Community 69 - "openai-key-prompt.tsx"
Cohesion: 0.29
Nodes (4): OpenAIKeyPrompt, ProviderKeyPrompt(), ProviderKeyPromptProps, useProviderKeyForm()
...
Cohesion: 0.10
Nodes (37): formatChatMessages(), SendChatPromptDetail, mocks, useChatPanel(), getCommandPendingKey(), useProductionTreeAdapter(), getVisiblePages(), NotebooksPage() (+29 more)
...
Cohesion: 0.22
Nodes (10): ConnectionStatus, fetchConnection(), ProviderStatus, useConnectionStatus(), getMotionComponent(), motionComponentCache, MotionHTMLProps, Shimmer (+2 more)

### Community 93 - "layout/index.ts"
Cohesion: 0.20
Nodes (8): HomePage(), NotebooksSection(), handleCreateNotebook(), Route, AppHeader(), NotebookHeader(), UserMenu(), Logo()
...
Cohesion: 0.21
Nodes (6): Route, Route, Route, authClient, redirectIfAuthenticated(), requireAuth()
...
Cohesion: 0.14
Nodes (13): ActiveGenerationCard(), Generation, getGenerationSubtitle(), isInScope(), ResourceButton(), ResourceConfig, RESOURCES, StudioResourcesProps (+5 more)
...
Cohesion: 0.14
Nodes (17): ChatPanelHeader(), ChatPanelHeaderProps, NotebookSettingsDialog(), StudioResources(), UseStudioDialogsReturn, Tabs(), TabsContent(), TabsList() (+9 more)
...
- **Why does `NotebooksPage()` connect `fetchApi` to `utils.ts`, `auth/index.ts`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `handlePageSelection()` connect `fetchApi` to `.assertNotebookOwner`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `cn`, `prompt-input.tsx`, `button.tsx`, `login-page.tsx`, `desktop-layout.tsx`, `landing-page.tsx`, `utils.ts`, `QuizView.tsx`, `code-block.tsx`, `notebook-workspace-container.tsx`, `StudyMaterialDTO`, `settings-page.tsx`, `plugins`, `controller.tsx`, `sources.ts`, `study-materials-tree.tsx`, `App.tsx`, `message.tsx`, `conversation.tsx`, `assistant-message.tsx`, `ui/model-selector.tsx`, `markdown-document-viewer.tsx`, `MindMapView.tsx`, `reasoning.tsx`, `RoadmapView.tsx`, `openai-key-prompt.tsx`, `web-search.ts`, `mobile-notebook-layout.tsx`, `fetchApi`, `study-materials-tree-container.tsx`, `ai/index.ts`, `layout/index.ts`, `MaterialViewer.tsx`, `file-upload-mode.tsx`, `theme/index.ts`, `add-source-dialog.tsx`?**
