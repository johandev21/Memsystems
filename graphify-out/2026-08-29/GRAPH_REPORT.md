...
## Corpus Check
- 586 files · ~294,373 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4703 nodes · 8150 edges · 381 communities (284 shown, 97 thin omitted)
...
- JobQueueService
- code-block.tsx
- study-material-viewer/index.ts
- Refine Frontend UI
- NotebooksService
- dropdown-menu.tsx
- Execution Control
...
- `ContextMenuSubTrigger()` --calls--> `cn()`  [EXTRACTED]
  frontend/src/components/ui/context-menu.tsx → frontend/src/shared/utils/cn.ts
...
- 4-file cycle: `frontend/src/features/notebooks/components/notebook-workspace/index.ts -> frontend/src/features/notebooks/components/notebook-workspace/mobile-notebook-layout.tsx -> frontend/src/features/notebooks/components/notebook-workspace/mobile-tabs-header.tsx -> frontend/src/features/notebooks/index.ts -> frontend/src/features/notebooks/components/notebook-workspace/index.ts`
...
- 4-file cycle: `frontend/src/features/study-material-tree/components/model/production-adapter.ts -> frontend/src/features/study-material-tree/components/model/tree.ts -> frontend/src/features/study-material-tree/index.ts -> frontend/src/features/study-material-tree/components/ui/study-materials-tree-container.tsx -> frontend/src/features/study-material-tree/components/model/production-adapter.ts`
- 4-file cycle: `frontend/src/features/study-material-tree/components/model/tree.ts -> frontend/src/features/study-material-tree/index.ts -> frontend/src/features/study-material-tree/components/ui/study-materials-tree-container.tsx -> frontend/src/features/study-material-tree/components/ui/study-materials-tree.tsx -> frontend/src/features/study-material-tree/components/model/tree.ts`
- 4-file cycle: `frontend/src/features/study-material-tree/components/model/tree.ts -> frontend/src/features/study-material-tree/index.ts -> frontend/src/features/study-material-tree/components/ui/study-materials-tree.tsx -> frontend/src/features/study-material-tree/components/ui/controller.tsx -> frontend/src/features/study-material-tree/components/model/tree.ts`

## Communities (381 total, 97 thin omitted)

### Community 0 - "content-normalizer.ts"
Cohesion: 0.06
Nodes (54): arrayLength(), extractJson(), generateTitle(), isRecord(), normalizeContent(), NormalizedFlashcard, NormalizedFlashcardContent, NormalizedMindMapContent (+46 more)
...
Cohesion: 0.11
Nodes (18): createFileSource(), reindexAllSources(), reindexSource(), sourceQueryOptions(), CODE_EXTENSIONS, detectDocumentType(), DocumentType, MARKDOWN_EXTENSIONS (+10 more)

### Community 3 - "prompt-input-files.ts"
Cohesion: 0.27
Nodes (7): PromptInput(), usePromptInputDropTarget(), convertBlobUrlToDataUrl(), convertFilePartsForSubmit(), matchesAccept(), PromptInputFileError, validateIncomingFiles()

### Community 4 - "QuizBriefForm.tsx"
Cohesion: 0.06
Nodes (60): Checkbox(), Popover(), PopoverContent(), PopoverDescription(), PopoverHeader(), PopoverTitle(), PopoverTrigger(), buildTree() (+52 more)

### Community 5 - "source-jobs.service.test.ts"
Cohesion: 0.09
Nodes (29): createDatabaseConnection(), fullSchema, chatRoleEnum, notebookChatMessages, sourceChunks, sourceIndexJobs, { db }, ensureTestDatabase() (+21 more)

### Community 6 - "schema.ts"
Cohesion: 0.07
Nodes (31): account, accountRelations, session, sessionRelations, user, userRelations, verification, generationRequests (+23 more)

### Community 7 - "auth.guard.ts"
Cohesion: 0.06
Nodes (27): All, AuthController, Controller, Res, AuthenticatedRequest, AuthGuard, Injectable, AuthModule (+19 more)

### Community 8 - "prompt-input.tsx"
Cohesion: 0.03
Nodes (66): HoverCard(), HoverCardTrigger(), AttachmentsContext, LocalAttachmentsContext, LocalReferencedSourcesContext, PromptInputActionAddAttachmentsProps, PromptInputActionAddScreenshotProps, PromptInputActionMenuContent() (+58 more)

### Community 9 - "notebooks.ts"
Cohesion: 0.17
Nodes (10): ChatPanelHeader(), ChatPanelHeaderProps, allNotebooksQueryOptions(), deleteNotebook(), fetchNotebooks(), notebookQueryOptions(), notebooksQueryOptions, NotebookSettingsDialog() (+2 more)

### Community 10 - ".assertNotebookOwner"
Cohesion: 0.09
Nodes (13): formatSourceJob(), textSourceSchema, urlSourceSchema, webSearchImportCandidateSchema, webSearchImportSchema, webSearchSchema, SourcesService, Injectable (+5 more)

### Community 11 - "react"
Cohesion: 0.07
Nodes (33): ALL_ICON_NAMES, CURATED_CATEGORIES, formatIconLabel(), IconItem, IconItemProps, IconPicker(), IconPickerProps, Input() (+25 more)
...
Cohesion: 0.08
Nodes (25): AppController, Controller, Get, AppModule, Module, AppService, Injectable, DomainExceptionFilter (+17 more)
...
### Community 15 - "IndexingService"
Cohesion: 0.11
Nodes (13): applyOverlap(), ChunkingService, ChunkInput, ChunkOptions, ChunkOutput, splitOnBoundaries(), Injectable, IndexingService (+5 more)

### Community 16 - "cn"
Cohesion: 0.07
Nodes (38): EmptyState(), EmptyStateProps, Spinner(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount() (+30 more)

### Community 17 - "ai/index.ts"
Cohesion: 0.09
Nodes (26): SelectContent(), SelectGroup(), SelectItem(), SelectLabel(), SelectScrollDownButton(), SelectScrollUpButton(), SelectSeparator(), SelectTrigger() (+18 more)

### Community 18 - "JobQueueService"
Cohesion: 0.06
Nodes (31): jobs, WebSearchResult, EnqueueOptions, Job, JobHandler, JobRow, JobStatus, OnConflictPolicy (+23 more)
...
### Community 20 - "study-material-viewer/index.ts"
Cohesion: 0.08
Nodes (27): FolderTreeNode, createFolder(), foldersQueryOptions(), updateFolder(), MobileStudyMaterialsPanel(), MobileStudyMaterialsPanelProps, CommandResult, getCommandPendingKey() (+19 more)
...
Cohesion: 0.10
Nodes (14): NotebooksService, toResponse(), Inject, Injectable, Inject, DevStorageController, Controller, Get (+6 more)

### Community 23 - "dropdown-menu.tsx"
Cohesion: 0.08
Nodes (22): Logo(), UserMenu(), DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent(), DropdownMenuGroup(), DropdownMenuItem(), DropdownMenuLabel() (+14 more)
...
Cohesion: 0.07
Nodes (36): buttonVariants, ResizableHandle(), ResizablePanel(), ResizablePanelGroup(), Tabs(), TabsContent(), TabsList(), tabsListVariants (+28 more)

### Community 30 - "study-materials-tree.tsx"
Cohesion: 0.11
Nodes (29): TreeNode, DRAG_ID_PREFIX, findTreeNode(), FOLDER_DROP_ID_PREFIX, getTreeDragData(), getTreeDropData(), useTreeControllerContext(), StudyMaterialsTree() (+21 more)

### Community 31 - "settings-page.tsx"
Cohesion: 0.12
Nodes (23): ConfirmDeleteDialogProps, AlertDialog(), AlertDialogAction(), AlertDialogCancel(), AlertDialogContent(), AlertDialogDescription(), AlertDialogFooter(), AlertDialogHeader() (+15 more)

### Community 32 - "connection.service.ts"
Cohesion: 0.08
Nodes (20): AiController, Body, Controller, Delete, Get, Post, UseGuards, UsePipes (+12 more)

### Community 33 - "cn.ts"
Cohesion: 0.13
Nodes (25): Badge(), badgeVariants, Button(), buttonVariants, CardFormat, detectCardFormat(), FlashcardItem, parseClozeCard() (+17 more)
...
### Community 35 - "SourcePolicyService"
Cohesion: 0.14
Nodes (9): DEFAULT_SOURCE_FETCH_CONFIG, HostnameResolver, SourcePolicyService, stripIpv6Brackets(), Inject, Injectable, Optional, bodyFrom() (+1 more)

### Community 36 - "controller.tsx"
Cohesion: 0.15
Nodes (29): LocalTreeAdapter, useLocalTreeAdapter(), TreeCommand, addToMap(), buildStudyMaterialTree(), byCreatedAtThenId(), canMoveItem(), createFolder() (+21 more)

### Community 37 - "routeTree.gen.ts"
Cohesion: 0.09
Nodes (27): LandingPage(), ConnectionPage(), SettingsLayout(), SettingsPage(), Route, Route, Route, Route (+19 more)

### Community 38 - "State Management: TanStack Query (React Query)"
Cohesion: 0.06
Nodes (30): API Request Handling, Auth data: `shared/auth/` or `shared/api/`, Auth UI: pages (single use) or features (multi-use), Authentication, Basic pattern: API calls in the consuming slice, Business-entity slice in entities, Code generation, CRUD helpers in shared (+22 more)
...
Cohesion: 0.16
Nodes (9): ZodValidationPipe, createNotebookSchema, updateNotebookSchema, createFolderSchema, createStudyMaterialSchema, generateRequestSchema, moveStudyMaterialSchema, updateFolderSchema (+1 more)

### Community 41 - "conversation.tsx"
Cohesion: 0.09
Nodes (28): MessageScroller(), MessageScrollerButton(), MessageScrollerContent(), MessageScrollerItem(), MessageScrollerProvider(), MessageScrollerViewport(), Conversation(), ConversationContent() (+20 more)

### Community 42 - "assistant-message.tsx"
Cohesion: 0.08
Nodes (28): Message(), MessageContent(), MessageResponseProps, CitedSourceDTO, AssistantMessage(), AssistantMessageProps, getReasoningText(), isTextPart() (+20 more)
...
Cohesion: 0.09
Nodes (23): ModelSelector(), ModelSelectorContent(), ModelSelectorEmpty(), ModelSelectorGroup(), ModelSelectorItem(), ModelSelectorList(), ModelSelectorName(), ModelSelectorTrigger() (+15 more)

### Community 46 - "Feature-Sliced Design (FSD) v2.1"
Cohesion: 0.07
Nodes (28): 10. Quick Reference, 11. Conditional References, 1. Core Philosophy & Layer Overview, 2. Decision Framework, 3. Quick Placement Table, 4-1. Import only from lower layers, 4-2. Public API: every slice exports through index.ts, 4-3. No cross-imports between slices on the same layer (+20 more)

### Community 47 - "teach/SKILL.md"
Cohesion: 0.07
...
Cohesion: 0.07
Nodes (27): App Router, Astro, Create React App (CRA), Database access, Directory structure, Directory structure, Directory structure, Directory structure (+19 more)

### Community 50 - "Creating Internal Packages"
Cohesion: 0.07
...
### Community 52 - "QuizView.tsx"
Cohesion: 0.10
Nodes (23): Dialog(), DialogContent(), DialogDescription(), DialogFooter(), DialogHeader(), DialogOverlay(), DialogTitle(), MODAL_POPOVER_LAYER (+15 more)
...
### Community 55 - "tasks"
Cohesion: 0.08
Nodes (24): ^build, dependsOn, description, outputs, cache, description, persistent, cache (+16 more)

### Community 56 - "Codebase Design"
Cohesion: 0.09
...
Cohesion: 0.09
Nodes (29): BadRequestError, DomainError, DomainErrorOptions, ForbiddenError, InternalError, NotFoundError, ServiceUnavailableError, sources (+21 more)

### Community 58 - "chat.controller.ts"
Cohesion: 0.09
Nodes (18): ChatController, chatRequestSchema, messagePartSchema, messageSchema, reasoningPartSchema, textPartSchema, Body, Controller (+10 more)

### Community 59 - "reasoning.tsx"
Cohesion: 0.10
Nodes (21): Collapsible(), CollapsibleContent(), CollapsibleTrigger(), Reasoning, ReasoningContent, ReasoningContentProps, ReasoningContext, ReasoningContextValue (+13 more)
...
### Community 64 - "Layer Structure Reference"
Cohesion: 0.09
...
Cohesion: 0.19
Nodes (16): DEFAULT_TOP_K, RetrievedChunk, CITATION_SCHEMA_VERSION, CitationEvidence, CitedSourceEntry, createCitationEvidence(), extractCitationEntries(), formatCitationContext() (+8 more)

### Community 66 - "components.json"
Cohesion: 0.09
Nodes (21): aliases, components, hooks, lib, ui, utils, iconLibrary, menuAccent (+13 more)

### Community 67 - "Part 2: Custom architecture → FSD"
Cohesion: 0.10
Nodes (20): Before you start, Common pitfalls during migration, Migrating from FSD v1 to v2, Migration Guide, Optional steps, Part 1: FSD v2.0 → v2.1 (non-breaking), Part 2: Custom architecture → FSD, Post-migration verification (+12 more)

### Community 68 - "Repository Structure"
Cohesion: 0.10
...
Cohesion: 0.10
Nodes (12): AppHeader(), EmptyState(), EmptyStateProps, Skeleton(), Spinner(), NotebookCard(), NotebookCardProps, Notebook (+4 more)
...
### Community 71 - "HTML Report Format"
Cohesion: 0.10
...
### Community 72 - "Critical Anti-Patterns"
Cohesion: 0.10
...
### Community 75 - "Better Auth Integration Guide"
Cohesion: 0.11
...
Cohesion: 0.22
Nodes (9): FetchedHtml, HttpFetcherService, isHtmlContentType(), readBoundedBody(), REDIRECT_STATUSES, Inject, Injectable, Optional (+1 more)
...
### Community 79 - "source-extraction.service.ts"
Cohesion: 0.19
Nodes (10): decodeUtf8(), DOCX_MIME_TYPES, ExtractionResult, MD_MIME_TYPES, normalizeText(), PDF_MIME_TYPES, SourceExtractionService, SupportedFileKind (+2 more)

### Community 80 - "Quick Reference"
Cohesion: 0.12
...
### Community 82 - "Global Options Reference"
Cohesion: 0.12
...
### Community 83 - "Task Configuration Reference"
Cohesion: 0.12
...
### Community 84 - "Other Filter Types"
Cohesion: 0.12
...
Cohesion: 0.09
Nodes (25): getRawText(), MarkdownCodeBlock(), MessageActionProps, MessageActions(), MessageActionsProps, MessageBranch(), MessageBranchContent(), MessageBranchContentProps (+17 more)
...
### Community 88 - "shared/api/index.ts"
Cohesion: 0.15
Nodes (15): deleteFolder(), UpdateFolderInput, CreateFolderInput, createStudyMaterial(), deleteStudyMaterial(), moveStudyMaterial(), updateStudyMaterial(), UpdateStudyMaterialInput (+7 more)

### Community 89 - "tasteskill: Anti-Slop Frontend Skill"
Cohesion: 0.18
Nodes (11): 0.A Read these signals first, 0.B Output a one-line "Design Read" before generating, 0. BRIEF INFERENCE (Read the Room Before Anything Else), 0.C If the brief is ambiguous, ask one question, do not guess, 0.D Anti-Default Discipline, 13. OUT OF SCOPE, 14. FINAL PRE-FLIGHT CHECK, 2.A When to reach for a real design system (use official packages) (+3 more)

### Community 90 - "Appendix B - Canonical Sources (read these before reinventing)"
Cohesion: 0.13
Nodes (15): Appendix B - Canonical Sources (read these before reinventing), Apple Liquid Glass (Apple platforms only), Atlassian, Bootstrap, Carbon, Fluent UI, GOV.UK, Material Web (+7 more)

### Community 91 - "scripts/package.json"
Cohesion: 0.13
...
Cohesion: 0.15
Nodes (10): redirectIfAuthenticated(), requireAuth(), NotebookHeader(), NotebookPage(), getVisiblePages(), NotebooksPage(), handleCreateNotebook(), handlePageSelection() (+2 more)
...
### Community 95 - "How to keep entities clean"
Cohesion: 0.14
Nodes (13): 0. Consider having no entities layer, 1. Avoid preemptive slicing, 2. Avoid unnecessary entities, 3. Exclude CRUD operations from entities, 4. Store authentication data in shared, 5. Minimize cross-imports, Anti-patterns, Decision summary (+5 more)

### Community 96 - "shadcn/SKILL.md"
Cohesion: 0.21
...
### Community 97 - "Customization & Theming"
Cohesion: 0.14
...
### Community 98 - "Common Filter Patterns"
Cohesion: 0.14
...
Cohesion: 0.14
Nodes (14): scripts, build, db:migrate, dev, format, lint, start, start:debug (+6 more)

### Community 100 - "exclude"
Cohesion: 0.14
...
Cohesion: 0.14
Nodes (13): Authentication, Codex adapter settings, Conclusion, Decisions required before implementation, Differences from the OpenAI provider path, Documented unknowns, Filesystem, sandbox, and deployment constraints, `generateText` and `streamText` compatibility (+5 more)

### Community 103 - "build-agents.ts"
Cohesion: 0.23
Nodes (12): CATEGORIES, __dirname, __filename, generateAgentsMd(), generateTableOfContents(), getCategoryForFile(), main(), parseFrontmatter() (+4 more)

### Community 104 - "Component Composition"
Cohesion: 0.15
...
### Community 105 - "Styling & Customization"
Cohesion: 0.15
...
### Community 106 - "Test-Driven Development"
Cohesion: 0.15
...
### Community 110 - "4. DESIGN ENGINEERING DIRECTIVES (Bias Correction)"
Cohesion: 0.17
...
### Community 113 - "How Turborepo Caching Works"
Cohesion: 0.17
...
### Community 114 - "CI Optimization Patterns"
Cohesion: 0.17
...
### Community 115 - "Configuration Keys"
Cohesion: 0.17
...
### Community 116 - "wayfinder/SKILL.md"
Cohesion: 0.17
...
Cohesion: 0.19
Nodes (6): EmbeddingService, Injectable, RetrievalService, Inject, Injectable, Inject

### Community 119 - "Study Materials — Surface Ladder Design Spec"
Cohesion: 0.17
Nodes (11): 1. Context → ladder mapping (authoritative), 2. Component recipes (from the reference mockups), 3. Text hierarchy, 4. Migration rules (mechanical), 5. Accent policy (success / error / warning states), 6. Hard constraints for every agent, 7. Verification sweep (final QA), Card / dialog container (+3 more)

### Community 120 - "Frontend Readable React Refactor Plan"
Cohesion: 0.17
...
### Community 122 - "home-page.tsx"
Cohesion: 0.38
Nodes (4): HomePage(), NotebooksSection(), handleCreateNotebook(), Route
...
### Community 126 - "turbo.json Configuration Overview"
Cohesion: 0.18
...
### Community 127 - "Quick Decision Trees"
Cohesion: 0.18
...
Cohesion: 0.07
Nodes (29): ansi-to-react, class-variance-authority, clsx, @fontsource/poppins, dependencies, ai, ansi-to-react, better-auth (+21 more)
...
Cohesion: 0.13
Nodes (10): Card(), CardAction(), CardContent(), CardDescription(), CardFooter(), CardHeader(), CardTitle(), AuthMode (+2 more)
...
### Community 132 - "10. REFERENCE VOCABULARY (Pattern Names the Agent Should Know)"
Cohesion: 0.20
Nodes (10): 10. REFERENCE VOCABULARY (Pattern Names the Agent Should Know), Animation Library Choice, Cards & Containers, Galleries & Media, Hero Paradigms, Layout & Grids, Micro-Interactions & Effects, Navigation & Menus (+2 more)

### Community 133 - "CI/CD with Turborepo"
Cohesion: 0.20
...
### Community 134 - "Vercel Deployment"
Cohesion: 0.20
...
### Community 141 - "Registry Authoring and Addresses"
Cohesion: 0.22
...
### Community 144 - "to-spec/SKILL.md"
Cohesion: 0.22
...
### Community 146 - "Environment Variable Gotchas"
Cohesion: 0.22
...
### Community 147 - "Environment Modes"
Cohesion: 0.22
...
Cohesion: 0.11
Nodes (15): defaultRehypePlugins, defaultRemarkPlugins, MarkdownComponents, MarkdownRenderer(), MarkdownRendererProps, markdownSanitizeSchema, RehypePlugins, RemarkPlugins (+7 more)
...
Cohesion: 0.22
Nodes (8): Current Baseline, Database Migration Strategy, Proposed Implementation Boundaries, Purpose, Recommended First Implementation Slice, Refactor Sequence, Source Ingestion Refactor Sequence, Verification Plan

### Community 151 - "plugins"
Cohesion: 0.22
...
### Community 154 - "Memsystems-AI"
Cohesion: 0.22
Nodes (9): Base de datos, Comandos principales, Desarrollo, Documentación, Estado del proyecto, Estructura del proyecto, Instalación, Memsystems-AI (+1 more)

### Community 155 - "Process"
Cohesion: 0.25
...
### Community 156 - "9. AI TELLS (Forbidden Patterns)"
Cohesion: 0.25
Nodes (8): 9.A Visual & CSS, 9. AI TELLS (Forbidden Patterns), 9.B Typography, 9.C Layout & Spacing, 9.D Content & Data ("Jane Doe" Effect), 9.E External Resources & Components, 9.F Production-Test Tells (banned outright), 9.G EM-DASH BAN (the single most-violated Tell)

### Community 157 - "Component Building Principles"
Cohesion: 0.25
Nodes (8): Animate enter states with @starting-style, Buttons must feel responsive, Component Building Principles, Make popovers origin-aware, Never animate from scale(0), Tooltips: skip delay on subsequent hovers, Use blur to mask imperfect transitions, Use CSS transitions over keyframes for interruptible UI

### Community 158 - "NestJS Best Practices"
Cohesion: 0.25
Nodes (7): Creating a New Rule, Getting Started, Installation, NestJS Best Practices, Rule File Structure, Structure, Supported Agents

### Community 159 - "Forms & Inputs"
Cohesion: 0.25
...
### Community 161 - "Backend (Vitest + real PostgreSQL)"
Cohesion: 0.25
Nodes (8): Backend (Vitest + real PostgreSQL), Configuration, Fixtures, How to run, Mocks, Prerequisites, Setup lifecycle, Testing

### Community 162 - "router.ts"
Cohesion: 0.15
Nodes (10): App(), AuthProvider(), AppProviders(), Register, router, RouterContext, @tanstack/react-router, authClient (+2 more)

### Community 163 - "Funcionalidades"
Cohesion: 0.25
Nodes (8): Chat contextual, Cuenta y almacenamiento, Fuentes de información, Funcionalidades, Materiales de estudio, Notebooks, Organización y papelera, Proveedores y modelos de IA

### Community 164 - "docker.mjs"
Cohesion: 0.19
Nodes (10): composeArgs, exampleEnvPath, getRunningProjectContainers(), [mode, action, ...extraArgs], privateEnvPath, runComposeDown(), runDockerCapture(), toWslPath() (+2 more)

### Community 165 - "conventional-commit/SKILL.md"
Cohesion: 0.29
Nodes (6): Commit Message Structure, Examples, Final Step, Instructions, Validation, Workflow

### Community 166 - "APPENDICES - Real Source-Backed Reference Material"
Cohesion: 0.29
...
### Community 167 - "11. REDESIGN PROTOCOL"
Cohesion: 0.29
Nodes (7): 11.A Detect the Mode (first action), 11.B Audit Before Touching, 11.C Preservation Rules, 11.D Modernisation Levers (priority order), 11.E Decision Tree: Targeted Evolution vs Full Redesign, 11.F What Never Changes Silently, 11. REDESIGN PROTOCOL

### Community 168 - "3. DEFAULT ARCHITECTURE & CONVENTIONS"
Cohesion: 0.29
Nodes (7): 3.A Stack, 3.B State, 3.C Icons, 3.D Emoji Policy, 3. DEFAULT ARCHITECTURE & CONVENTIONS, 3.E Responsiveness & Layout Mechanics, 3.F Dependency Verification (mandatory)

### Community 169 - "6. PERFORMANCE & ACCESSIBILITY GUARDRAILS"
Cohesion: 0.29
Nodes (7): 6.A Hardware Acceleration, 6.B Reduced Motion (mandatory), 6.C Dark Mode (mandatory for any consumer-facing page), 6.D Core Web Vitals Targets, 6.E DOM Cost, 6.F Z-Index Restraint, 6. PERFORMANCE & ACCESSIBILITY GUARDRAILS

### Community 170 - "Frontend Design"
Cohesion: 0.29
Nodes (6): Design principles, Frontend Design, Ground it in the subject, More on writing in design, Process: brainstorm, explore, plan, critique, build, critique again, Restraint and self-critique

### Community 171 - "1. Architecture"
Cohesion: 0.29
Nodes (7): 1.1 Avoid Circular Dependencies, 1.2 Organize by Feature Modules, 1.3 Use Proper Module Sharing Patterns, 1.4 Single Responsibility for Services, 1.5 Use Event-Driven Architecture for Decoupling, 1.6 Use Repository Pattern for Data Access, 1. Architecture

### Community 172 - "2. Dependency Injection"
Cohesion: 0.29
Nodes (7): 2.1 Avoid Service Locator Anti-Pattern, 2.2 Apply Interface Segregation Principle, 2.3 Honor Liskov Substitution Principle, 2.4 Prefer Constructor Injection, 2.5 Understand Provider Scopes, 2.6 Use Injection Tokens for Interfaces, 2. Dependency Injection
...
Cohesion: 0.20
Nodes (18): cancelGeneration(), GenerationEvent, iteratorFrom(), MindMapGenerationOptions, parseLine(), RoadmapGenerationOptions, startGeneration(), StartGenerationInput (+10 more)
...
### Community 178 - "clip-path for Animation"
Cohesion: 0.33
Nodes (6): clip-path for Animation, Comparison sliders, Hold-to-delete pattern, Image reveals on scroll, Tabs with perfect color transitions, The inset shape

### Community 179 - "Performance Rules"
Cohesion: 0.33
Nodes (6): CSS animations beat JS under load, CSS variables are inheritable, Framer Motion hardware acceleration caveat, Only animate transform and opacity, Performance Rules, Use WAAPI for programmatic CSS animations

### Community 180 - "Gesture and Drag Interactions"
Cohesion: 0.33
Nodes (6): Damping at boundaries, Friction instead of hard stops, Gesture and Drag Interactions, Momentum-based dismissal, Multi-touch protection, Pointer capture for drag

### Community 181 - "4. Security"
Cohesion: 0.33
Nodes (6): 4.1 Implement Secure JWT Authentication, 4.2 Implement Rate Limiting, 4.3 Sanitize Output to Prevent XSS, 4.4 Use Guards for Authentication and Authorization, 4.5 Validate All Input with DTOs and Pipes, 4. Security

### Community 182 - "nest-cli.json"
Cohesion: 0.33
Nodes (5): collection, compilerOptions, deleteOutDir, $schema, sourceRoot

### Community 183 - "backend/package.json"
Cohesion: 0.33
...
Cohesion: 0.33
Nodes (6): 1.1 Landing route and page — highest priority, 1.2 Settings page — highest priority, 1.3 All notebooks page, 1.4 Notebook workspace layouts, 1.5 Focused shell cleanups, Packet 1 — Application shell and pages

### Community 186 - "Packet 4 — Notebooks and sources"
Cohesion: 0.33
...
Cohesion: 0.17
Nodes (6): GenerationRequestManager, Inject, Injectable, GenerationService, Inject, Injectable
...
Cohesion: 0.33
Nodes (6): Add browser rendering as a fallback, Avoid LLM-based extraction by default, Decisions, Defer full crawling, Keep the existing fast path, Prefer TypeScript-native crawling

### Community 191 - "graphify reference: query, path, explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 192 - "memsystems - Agent Instructions"
Cohesion: 0.40
Nodes (5): Commands, Docs, graphify, memsystems - Agent Instructions, Skills

### Community 193 - "color-hierarchy/SKILL.md"
Cohesion: 0.40
Nodes (4): Failure modes these rules prevent, Rules, Steps, Tokens

### Community 194 - "12. THE BLOCK LIBRARY (Contract - Implementations Land Here Iteratively)"
Cohesion: 0.40
Nodes (5): 12.A File Location, 12.B Required Frontmatter, 12.C Required Body Sections, 12.D Block-Library Discipline, 12. THE BLOCK LIBRARY (Contract - Implementations Land Here Iteratively)

### Community 195 - "5. CONTEXT-AWARE PROACTIVITY"
Cohesion: 0.40
Nodes (5): 5.A Sticky-Stack - Canonical Skeleton, 5.B Horizontal-Pan - Canonical Skeleton, 5.C Scroll-Reveal Stagger - Canonical Skeleton (lighter alternative), 5. CONTEXT-AWARE PROACTIVITY, 5.D Forbidden Animation Patterns

### Community 196 - "8. DARK MODE PROTOCOL"
Cohesion: 0.40
Nodes (5): 8.A Token Strategy (pick one, stick to it), 8.B Do Not Prescribe Specific Colors Here, 8.C Default Mode, 8.D Test in Both Modes Before Finishing, 8. DARK MODE PROTOCOL

### Community 197 - "CSS Transform Mastery"
Cohesion: 0.40
Nodes (5): 3D transforms for depth, CSS Transform Mastery, scale() scales children too, transform-origin, translateY with percentages

### Community 198 - "The Sonner Principles (Building Loved Components)"
Cohesion: 0.40
Nodes (5): Asymmetric enter/exit timing, Cohesion matters, Review your work the next day, The opacity + height combination, The Sonner Principles (Building Loved Components)

### Community 199 - "Spring Animations"
Cohesion: 0.40
Nodes (5): Interruptibility advantage, Spring Animations, Spring-based mouse interactions, Spring configuration, When to use springs

### Community 200 - "NestJS Best Practices"
Cohesion: 0.40
Nodes (4): Abstract, NestJS Best Practices, References, Table of Contents

### Community 201 - "5. Performance"
Cohesion: 0.40
Nodes (5): 5.1 Use Async Lifecycle Hooks Correctly, 5.2 Use Lazy Loading for Large Modules, 5.3 Optimize Database Queries, 5.4 Use Caching Strategically, 5. Performance

### Community 202 - "8. API Design"
Cohesion: 0.40
Nodes (5): 8.1 Use DTOs and Serialization for API Responses, 8.2 Use Interceptors for Cross-Cutting Concerns, 8.3 Use Pipes for Input Transformation, 8.4 Use API Versioning for Breaking Changes, 8. API Design

### Community 203 - "9. Microservices"
Cohesion: 0.40
Nodes (5): 9.1 Implement Health Checks for Microservices, 9.2 Use Message and Event Patterns Correctly, 9.3 Use Message Queues for Background Jobs, 9. Microservices, Kubernetes Configuration

### Community 204 - "Domain documentation"
Cohesion: 0.40
Nodes (4): Architecture decisions, Before exploring, Domain documentation, Vocabulary

### Community 205 - "Issue tracker: GitHub"
Cohesion: 0.40
Nodes (4): Blocking relationships, Conventions, Issue tracker: GitHub, Publishing

### Community 206 - "Database"
Cohesion: 0.40
Nodes (5): Connection, Database, Pushing schema changes, Schema, Test database

### Community 207 - "Packet 3 — Notebook chat after PromptInput stabilizes"
Cohesion: 0.40
Nodes (5): 3.1 Assistant message, 3.2 Composer, 3.3 Chat panel, 3.4 Small chat cleanups, Packet 3 — Notebook chat after PromptInput stabilizes

### Community 208 - "Packet 5 — Study-material generation"
Cohesion: 0.40
Nodes (5): 5.1 Lock form behavior, 5.2 One owner extracts only genuine picker duplication, 5.3 Refactor forms independently after picker contracts land, 5.4 Dialog last, Packet 5 — Study-material generation

### Community 209 - "Packet 6 — Study-material viewers"
Cohesion: 0.40
...
### Community 211 - "kind-labels.ts"
Cohesion: 0.12
Nodes (8): KIND_PLURAL_LABELS, RoadmapContent, RoadmapContentType, RoadmapPhase, RoadmapTopic, SimpleFlashcardContent, SimpleFlashcardContentType, CreateStudyMaterialInput
...
Cohesion: 0.10
Nodes (20): SourceMetadata, WebScrapeError, WebScrapeErrorCode, buildS3Key(), CreateTextSourceInput, CreateUrlSourceInput, DownloadInfo, looksLikeUrlTitle() (+12 more)

### Community 216 - "frontend/tsconfig.json"
Cohesion: 0.40
Nodes (4): compilerOptions, paths, files, references

### Community 217 - "Docker"
Cohesion: 0.40
Nodes (5): Comandos Docker, Configuración, Desarrollo con recarga automática, Docker, Stack local similar a producción

### Community 218 - "7. DIAL DEFINITIONS (Technical Reference)"
Cohesion: 0.50
Nodes (4): 7. DIAL DEFINITIONS (Technical Reference), DESIGN_VARIANCE (Level 1-10), MOTION_INTENSITY (Level 1-10), VISUAL_DENSITY (Level 1-10)

### Community 219 - "hitl-loop.template.sh"
Cohesion: 0.83
Nodes (3): capture(), hitl-loop.template.sh script, step()

### Community 220 - "Core Philosophy"
Cohesion: 0.50
Nodes (4): Beauty is leverage, Core Philosophy, Taste is trained, not innate, Unseen details compound

### Community 221 - "Debugging Animations"
Cohesion: 0.50
Nodes (4): Debugging Animations, Frame-by-frame inspection, Slow motion testing, Test on real devices

### Community 222 - "10. DevOps & Deployment"
Cohesion: 0.50
Nodes (4): 10.1 Implement Graceful Shutdown, 10.2 Use ConfigModule for Environment Configuration, 10.3 Use Structured Logging, 10. DevOps & Deployment

### Community 223 - "3. Error Handling"
Cohesion: 0.50
Nodes (4): 3.1 Handle Async Errors Properly, 3.2 Throw HTTP Exceptions from Services, 3.3 Use Exception Filters for Error Handling, 3. Error Handling

### Community 224 - "6. Testing"
Cohesion: 0.50
Nodes (4): 6.1 Use Supertest for E2E Testing, 6.2 Mock External Services in Tests, 6.3 Use Testing Module for Unit Tests, 6. Testing

### Community 225 - "7. Database & ORM"
Cohesion: 0.50
Nodes (4): 7.1 Avoid N+1 Query Problems, 7.2 Use Database Migrations, 7.3 Use Transactions for Multi-Step Operations, 7. Database & ORM

### Community 226 - "GLOSSARY.md Format"
Cohesion: 0.50
Nodes (3): GLOSSARY.md Format, Rules, Structure

### Community 227 - "Packet 0 — Lock behavior and remove confirmed waste"
Cohesion: 0.50
Nodes (4): 0.1 Reconfirm the baseline, 0.2 Add characterization coverage before high-risk edits, 0.3 Delete the confirmed unreachable legacy study-materials tree, Packet 0 — Lock behavior and remove confirmed waste

### Community 228 - "Packet 2 — AI component platform"
Cohesion: 0.50
Nodes (4): 2.1 Prompt input — highest risk and highest value, 2.2 Code block, 2.3 Focused AI lifecycle components, Packet 2 — AI component platform

### Community 229 - "Packet 7 — Current production study-materials tree"
Cohesion: 0.50
Nodes (4): 7.1 Model and adapter first, 7.2 Controller without a public rewrite, 7.3 Row, root, and container, Packet 7 — Current production study-materials tree

### Community 230 - "Explicit exclusions and patterns to preserve"
Cohesion: 0.50
Nodes (4): Already-readable feature files, Decision gates, not refactor targets, Explicit exclusions and patterns to preserve, Generated and adapter-style files

### Community 231 - "Verification matrix"
Cohesion: 0.50
Nodes (4): Browser smoke matrix, Final repository gate, Per packet, Verification matrix

### Community 232 - "Phase 0: Establish behavior and measurements"
Cohesion: 0.50
Nodes (4): Exit criteria, Goals, Phase 0: Establish behavior and measurements, Work

### Community 233 - "Phase 1: Harden URL acquisition"
Cohesion: 0.50
Nodes (4): Exit criteria, Goals, Phase 1: Harden URL acquisition, Work

### Community 234 - "Phase 2: Introduce a normalized document contract"
Cohesion: 0.50
Nodes (4): Exit criteria, Goals, Phase 2: Introduce a normalized document contract, Work

### Community 235 - "Phase 4: Add targeted JavaScript rendering"
Cohesion: 0.50
Nodes (4): Exit criteria, Goals, Phase 4: Add targeted JavaScript rendering, Work

### Community 236 - "Phase 5: Make indexing durable and recoverable"
Cohesion: 0.50
Nodes (4): Exit criteria, Goals, Phase 5: Make indexing durable and recoverable, Work

### Community 237 - "Phase 6: Replace character-only chunking with structural chunking"
Cohesion: 0.50
Nodes (4): Exit criteria, Goals, Phase 6: Replace character-only chunking with structural chunking, Work

### Community 238 - "Phase 7: Improve deduplication and source identity"
Cohesion: 0.50
Nodes (4): Exit criteria, Goals, Phase 7: Improve deduplication and source identity, Work

### Community 239 - "Phase 8: Improve retrieval and citations"
Cohesion: 0.50
Nodes (4): Exit criteria, Goals, Phase 8: Improve retrieval and citations, Work

### Community 240 - "Phase 9: Add multi-page crawling as a separate product capability"
Cohesion: 0.50
Nodes (4): Exit criteria, Goals, Phase 9: Add multi-page crawling as a separate product capability, Work

### Community 241 - "Phase 10: Optional metadata enrichment"
Cohesion: 0.50
Nodes (4): Exit criteria, Goals, Phase 10: Optional metadata enrichment, Work

### Community 242 - "React + TypeScript + Vite"
Cohesion: 0.50
Nodes (3): Expanding the Oxlint configuration, React Compiler, React + TypeScript + Vite

### Community 243 - "opencode.json"
Cohesion: 0.50
Nodes (3): plugin, $schema, .opencode/plugins/graphify.js

### Community 244 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 245 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
...
### Community 248 - "Scope and non-goals"
Cohesion: 0.67
Nodes (3): In scope, Out of scope, Scope and non-goals

### Community 249 - "sources.module.ts"
Cohesion: 0.13
Nodes (17): AiModule, Global, Module, defaultResolver, expandIpv6(), globToRegex(), isPrivateAddress(), isPrivateIpv4() (+9 more)

### Community 251 - "add-source-dialog.tsx"
Cohesion: 0.17
Nodes (16): DialogTrigger(), createTextSource(), createUrlSource(), SOURCE_LIMIT, AddSourceDialog(), deriveTitleFromUrl(), TextInputMode(), UrlInputMode() (+8 more)

### Community 252 - "Find Skills"
Cohesion: 0.14
Nodes (13): Common Skill Categories, Find Skills, How to Help Users Find Skills, Step 1: Understand What They Need, Step 2: Check the Leaderboard First, Step 3: Search for Skills, Step 4: Verify Quality Before Recommending, Step 5: Present Options to the User (+5 more)

### Community 297 - "LoginPage"
Cohesion: 0.24
Nodes (9): getAuthCallbackUrl(), getAuthErrorMessage(), isUnverifiedEmailError(), LoginPage(), ensureOnline(), handleCredentials(), handleGoogleSignIn(), handleResend() (+1 more)

### Community 298 - "providers/index.tsx"
Cohesion: 0.31
Nodes (6): getQueryClient(), makeQueryClient(), QueryProvider(), AppThemeProvider(), ThemeShortcutListener(), useThemeKeyboardShortcut()
...
### Community 301 - "PromptInputTextarea"
Cohesion: 0.22
Nodes (7): PromptInputActionAddAttachments(), PromptInputActionAddScreenshot(), PromptInputTextarea(), useOptionalPromptInputController(), useOptionalProviderAttachments(), usePromptInputAttachments(), capturePromptInputScreenshot()

### Community 303 - "pending-upload-row.tsx"
Cohesion: 0.36
Nodes (6): getKindIcon(), PendingUploadRow(), PendingUploadRowProps, PendingSourceUpload, UploadStoreState, SourceKind

### Community 306 - "quiz.ts"
Cohesion: 0.22
Nodes (7): QuizContent, QuizContentData, QuizContentType, QuizOption, QuizQuestion, QuizQuestionData, QuizQuestionOption

### Community 307 - "StudyMaterialService"
Cohesion: 0.22
Nodes (3): StudyMaterialService, Inject, Injectable

### Community 308 - "detect-document-type.ts"
Cohesion: 0.25
...
### Community 320 - "input-group.tsx"
Cohesion: 0.40
Nodes (4): InputGroup(), InputGroupAddon(), InputGroupButton(), InputGroupTextarea()
...
## Knowledge Gaps
- **2137 isolated node(s):** `__filename`, `__dirname`, `CATEGORIES`, `RuleFrontmatter`, `Rule` (+2132 more)
...
- **Why does `react` connect `react` to `login-page.tsx`, `prompt-input-files.ts`, `QuizBriefForm.tsx`, `source-content-viewer.tsx`, `auth.guard.ts`, `prompt-input.tsx`, `notebooks.ts`, `context-menu.tsx`, `cn`, `ai/index.ts`, `code-block.tsx`, `markdown-document-viewer.tsx`, `study-material-viewer/index.ts`, `dropdown-menu.tsx`, `plugins`, `desktop-layout.tsx`, `study-materials-tree.tsx`, `settings-page.tsx`, `cn.ts`, `router.ts`, `controller.tsx`, `conversation.tsx`, `providers/index.tsx`, `assistant-message.tsx`, `tree.test.ts`, `composer.tsx`, `article-document-viewer.tsx`, `QuizView.tsx`, `use-chat-panel.ts`, `shimmer.tsx`, `web-search.ts`, `reasoning.tsx`, `MindMapView.tsx`, `components/model-selector.tsx`, `input-group.tsx`, `notebooks-page.tsx`, `RoadmapView.tsx`, `message.tsx`, `MaterialViewer.tsx`, `file-upload-mode.tsx`, `palette-provider.tsx`, `add-source-dialog.tsx`?**
  _High betweenness centrality (0.172) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `studio-resources.tsx`, `login-page.tsx`, `prompt-input-files.ts`, `QuizBriefForm.tsx`, `source-content-viewer.tsx`, `prompt-input.tsx`, `context-menu.tsx`, `react`, `ai/index.ts`, `code-block.tsx`, `markdown-document-viewer.tsx`, `study-material-viewer/index.ts`, `dropdown-menu.tsx`, `desktop-layout.tsx`, `study-materials-tree.tsx`, `settings-page.tsx`, `cn.ts`, `conversation.tsx`, `assistant-message.tsx`, `composer.tsx`, `PromptInputTextarea`, `pending-upload-row.tsx`, `article-document-viewer.tsx`, `QuizView.tsx`, `shimmer.tsx`, `reasoning.tsx`, `MindMapView.tsx`, `components/model-selector.tsx`, `input-group.tsx`, `notebooks-page.tsx`, `RoadmapView.tsx`, `message.tsx`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `DRIZZLE` connect `notebooks.service.ts` to `connection.service.ts`, `chat.service.ts`, `content-normalizer.ts`, `auth.guard.ts`, `JobQueueService`, `sources.service.ts`?**
...
- **Should `source-content-viewer.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.11330049261083744 - nodes in this community are weakly interconnected._
- **Should `QuizBriefForm.tsx` be split into smaller, more focused modules?**
